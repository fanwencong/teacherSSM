	...
	<center>
			...
			<form action="updateTeacher" method="post" >
				...
				<tr>
					...
					<td><input type="password" name="password" value="${teacher.password}"></td>
				...
				<tr>
					...
					<td><input type="text" name="picUrl" value="${teacher.picUrl}"></td>
					<td style=" color:#CC3300">${picUrl}</td>
				</tr>
				<tr>
					<td align="right">学校名称:</td>
					<td><input type="text" name="schoolName" value="${teacher.schoolName}"></td>
					<td style=" color:#CC3300">${schoolName}</td>
				</tr>
				<tr>
					<td align="right">备注:</td>
					<td><input type="text" name="remark" value="${teacher.remark}"></td>
